#!/usr/bin/python3
# manage-corpus.py revision build-dir corpus-dir
#   Given a corpus, try to maximal reduce all examples.  Will also print
#   errors for any obvious malformed entiries in the corpus.
#
